...
// Qt6: QTextCodec moved to QtCore5Compat. We provide a minimal UTF-8 stub
// so that QuaZip compiles without requiring the QtCore5Compat module.
...
public:
    ...
    QString toUnicode(const QByteArray &data) const { return QString::fromUtf8(data); }
    QString toUnicode(const char *data) const { return QString::fromUtf8(data); }
